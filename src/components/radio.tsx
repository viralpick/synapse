...
export interface RadioGroupProps {
  ref?: React.Ref<React.ElementRef<typeof RadioPrimitive.Root>>;
 ...
 * ```
 */
export interface RadioGroupItemProps extends Omit<VariantProps<typeof radioVariants>, "checked"> {
  ref?: React.Ref<React.ElementRef<typeof RadioPrimitive.Item>>;
  size?: "sm" | "md";
  value: string;
  disabled?: boolean;
  className?: string;
 ...
 * ```
 */
function RadioGroupItem({ ref, className, size = "sm", ...props }: RadioGroupItemProps) {
  return (
    <RadioPrimitive.Item
      ref={ref}
