 ...
 */
export function TabsTrigger({ ref, value: tabValue, className, children, ...props }: TabsTriggerProps) {
 ...
 * 연결된 탭이 활성화되면 표시됩니다.
 */
export function TabsContent({ ref, value: tabValue, className, children, ...props }: TabsContentProps) {
