...
function Command({
  ...
  return (
    <CommandPrimitive
      data-slot="command"
      className={cn(
        "bg-background-0 text-text-primary flex h-full w-full flex-col overflow-hidden rounded-md",
        className
      )}
      {...props}
    />
...
function CommandDialog({
  ...
  return (
    <Dialog {...props}>
      ...
      >
        <Command className="[&_[cmdk-group-heading]]:text-text-secondary **:data-[slot=command-input-wrapper]:h-3 [&_[cmdk-group-heading]]:px-0.5 [&_[cmdk-group-heading]]:font-medium [&_[cmdk-group]]:px-0.5 [&_[cmdk-group]:not([hidden])_~[cmdk-group]]:pt-0 [&_[cmdk-input-wrapper]_svg]:size-5 [&_[cmdk-input]]:h-3 [&_[cmdk-item]]:px-0.5 [&_[cmdk-item]]:py-0.75 [&_[cmdk-item]_svg]:size-5">
          {children}
        </Command>
      </DialogContent>
    </Dialog>
  ...
  return (
    ...
    >
      ...
      <CommandPrimitive.Input
        ...
        className={cn(
          "placeholder:text-text-secondary flex h-9 w-full rounded-medium bg-transparent py-3 text-sm outline-hidden disabled:cursor-not-allowed disabled:opacity-50",
          className
        )}
        {...props}
      />
...
function CommandSeparator({
  ...
  return (
    <CommandPrimitive.Separator
      ...
      className={cn("bg-border-100 -mx-1 h-px", className)}
      {...props}
    />
  );
}
...
function CommandItem({
  ...
  return (
    <CommandPrimitive.Item
      ...
      className={cn(
        "data-[selected=true]:bg-background-100 data-[selected=true]:text-text-primary [&_svg:not([class*='text-'])]:text-text-secondary relative flex cursor-default items-center gap-2 rounded-small px-2 py-1.5 text-sm outline-hidden select-none data-[disabled=true]:pointer-events-none data-[disabled=true]:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
        className
      )}
      {...props}
    />
