 ...
 */
export interface DatePickerItemProps extends Omit<VariantProps<typeof datePickerItemVariants>, "state"> {
  date: Date;
  className?: string;
}
 ...
 */
export interface DatePickerHeaderProps extends VariantProps<typeof datePickerHeaderVariants> {
  className?: string;
}
 ...
 * @property {"sm" | "md"} size - 크기
 */
export interface DatePickerFieldProps extends Omit<VariantProps<typeof datePickerFieldVariants>, "error" | "disabled"> {
...
export type DatePickerProps = DatePickerOwnProps &
  Omit<DatePickerProviderProps, "children"> &
  Omit<DatePickerFieldProps, keyof DatePickerOwnProps | "defaultValue">;
