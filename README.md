...
GitHub Package Registry에서 설치할 수 있습니다.

```bash
npm install @viralpick/synapse
```

> `.npmrc`에 스코프 레지스트리 설정이 필요합니다:
>
> ```
> @viralpick:registry=https://npm.pkg.github.com
> ```
...
```tsx
import { Button, Badge, Card } from "@viralpick/synapse";
import "@viralpick/synapse/styles.css";
```
...
```tsx
import { cn } from "@viralpick/synapse";
